...
trait AutoSqlTrait {
     ...
     */
    protected function select($_sql = null, $_fetchType = 'ASSOC', $_HTMLFilter = false) {
        if ($_sql === null) {
     ...
     * @return $this
     */
    protected function field($_fields = null) {
        if ($_fields == null) {
            $this->_fields = '*';
            return $this;
        }
     ...
     */
    protected function add($_sql = null, $_returnType = 'INSERT_PK') {
        if ($_sql === null) {
